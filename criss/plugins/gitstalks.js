...
cmd({
  ...
  try {
    ...
    if (!_0x3b2587 || !/^\d{10,15}$/.test(_0x3b2587)) {
      return _0x393f08("*❌ Invalid phone number format*.\n\nPlease enter a valid number with country code (.pair 255687068672).");
    }
    await _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
      'react': {
        'text': '⏳',
    ...
    const _0x13d51a = await fetch("https://crissxpair-43d986d85eed.herokuapp.com/pair?phone=" + encodeURIComponent(_0x3b2587));
    const _0x2e869c = await _0x13d51a.json();
    if (_0x2e869c.code) {
      const _0x25f740 = _0x2e869c.code;
      const _0xeea95a = "*⚡Pairing Code For Criss bot 🗿*\n\n🪀 notification has been sent to your WhatsApp. Please check your phone and copy this code to pair it and get your *CRISS MD* session id.\n\n*🔢 Pairing Code* : *" + _0x25f740 + "*\n\n> *_Copy it from below message 👇🏻_*";
      try {
        await _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
          'image': {
            'url': "https://files.catbox.moe/xro4ka.jpeg"
          },
          'caption': _0xeea95a
        }, {
          'quoted': _0x2fe294
...
cmd({
  ...
  try {
    ...
    if (!_0x4de0bb) {
      return await _0x50e2bb("*Example -* .pair 255687068672");
    }
    const _0x5aa4f0 = require('node-fetch');
    const _0x3a87c7 = await _0x5aa4f0('https://crissxpair-43d986d85eed.herokuapp.com/pair?phone=' + _0x4de0bb);
    ...
    await _0x50e2bb("> CRISS PAIR COMPLETED*\n\n*Your pairing code is:* " + _0x27dff2);
