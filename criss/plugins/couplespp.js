...
cmd({
  ...
  try {
    _0x30d3fc("*CRISS MD IS 💑 Fetching couple profile pictures...*");
    ...
    if (_0x5d4b91) {
      await _0x552520.sendMessage(_0x556c44, {
        ...
        'caption': "CRISS MD SUGGESTS: 👨 Male Couple Profile Picture"
      }, {
        'quoted': _0x51cf3f
      });
    }
    if (_0x5a1e4a) {
      await _0x552520.sendMessage(_0x556c44, {
        ...
        'caption': "CRISS MD SUGGESTS: 👩 Female Couple Profile Picture"
      }, {
        'quoted': _0x51cf3f
      });
    }
