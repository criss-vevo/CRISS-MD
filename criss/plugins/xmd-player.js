...
Creator      : CRISS VEVO
Repo         : https://github.com/criss-vevo/CRISS-VMD
...
cmd({
  ...
  try {
    ...
    await reply("> 𝐂𝐫𝐢𝐬𝐬 𝐌𝐝 𝐒𝐞𝐚𝐫𝐜𝐡𝐢𝐧𝐠 𝐕𝐢𝐝𝐞𝐨..... 𝑃𝑙𝑒𝑎𝑠𝑒 𝑊𝑎𝑖𝑡.....");
    ...
    await reply("> 𝐂𝐫𝐢𝐬𝐬 𝐌𝐝 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 𝐕𝐢𝐝𝐞𝐨... 𝑃𝑙𝑒𝑎𝑠𝑒 𝑊𝑎𝑖𝑡....");
    ...
    await reply("> 𝐂𝐫𝐢𝐬𝐬 𝐌𝐝 𝐒𝐞𝐧𝐝𝐢𝐧𝐠 𝐕𝐢𝐝𝐞𝐨... 𝑝𝑙𝑒𝑎𝑠𝑒 𝑤𝑎𝑖𝑡...");
...
await reply("> 𝐂𝐫𝐢𝐬𝐬 𝐌𝐝 𝐒𝐞𝐚𝐫𝐜𝐡𝐢𝐧𝐠 𝐒𝐨𝐧𝐠... 𝑃𝑙𝑒𝑎𝑠𝑒 𝑤𝑎𝑖𝑡...");
...
await reply("> 𝐂𝐫𝐢𝐬𝐬 𝐌𝐝 𝐒𝐞𝐚𝐫𝐜𝐡𝐢𝐧𝐠  𝐅𝐨𝐫 𝐒𝐨𝐧𝐠......");
...
const downloadURL = response.data.result.download_url;
await reply("> 𝐂𝐫𝐢𝐬𝐬 𝐌𝐝 𝐒𝐞𝐧𝐝𝐢𝐧𝐠 𝐒𝐨𝐧𝐠 ......");
