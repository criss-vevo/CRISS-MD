...
BOT_NAME: process.env.BOT_NAME || "✦CRISS MD",
// add bot name here for menu

CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
// make this true for custum emoji react   

STICKER_NAME: process.env.STICKER_NAME || "CRISS-MD",
...
LIVE_MSG: process.env.LIVE_MSG || "> ✦CRISS MD✦ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ\n\n\nᴋᴇᴇᴘ ᴜsɪɴɢ ✦CRISS MD✦ ғʀᴏᴍ CRISS VEVO⚡\n\n\n*© ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ - ᴍᴅ\n\n> ɢɪᴛʜᴜʙ :* https://github.com/criss-vevo/CRISS-MD",
// add alive msg here 
...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*🎉 Status Seen by CRISS MD 🌟*",
